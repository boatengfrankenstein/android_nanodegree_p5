...
public class ItemsContract {
    ...
    public static final Uri BASE_URI = Uri.parse("content://" + BuildConfig.APPLICATION_ID);
    ...
    public static class Items implements ItemsColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd." + BuildConfig.APPLICATION_ID + ".items";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd." + BuildConfig.APPLICATION_ID + ".items";
        ...
        public static long getItemId(Uri itemUri) {
            return Long.parseLong(itemUri.getPathSegments()
                                         .get(1));
        }
    }
